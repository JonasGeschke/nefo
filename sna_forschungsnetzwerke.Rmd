---
title: "NeFo-Forschungsatlas Soziale Netzwerkanalyse"
...
# Einleitung
Dieses ist das Skript der Netzwerkanalyse zu NeFo auf Grundlage des NeFo-Forschungsatlas. Die komplette Netzwerkanalyse ist einsehbar unter
XXX
...
create_nodes_forschungsnetzwerke <- function(Gdata){
    w1 <- colnames(Gdata)
    w2 <- rownames(Gdata)
...
create_links_forschungsnetzwerke <- function(Gdata){
    w1 <- colnames(Gdata)
    w2 <- rownames(Gdata)
    w3 <- c(paste("net", c(1:ncol(Gdata)), sep = ""))
    w4 <- c(paste("inst", c(1:nrow(Gdata)), sep = ""))
...
# 1-mode
nodes_fn_inst <- create_nodes_forschungsnetzwerke(Gdata_FN)
links_fn_inst <- create_links_forschungsnetzwerke(Gdata_FN)
