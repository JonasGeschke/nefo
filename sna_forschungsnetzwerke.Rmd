...
regr_institutionen <- data.frame(degree = forschungsnetzwerke_sna[c(12:nrow(forschungsnetzwerke_sna)),5], betweenness = forschungsnetzwerke_sna[c(12:nrow(forschungsnetzwerke_sna)),6])
