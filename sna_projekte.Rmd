...
Suche <- paste("http:_//gepris.dfg.de/gepris/OCTOPUS?context=project&findButton=Finden&keywords_criterion=", keywords, "&language=de&nurProjekteMitAB=false&task=doSearchSimple")
