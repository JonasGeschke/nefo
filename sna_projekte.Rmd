...
monitoring <- subset_projects(keywords = c("biodiv", "monitoring"))
monitoring <- subset_projects(keyword = c("biodiversitätsmonitoring", "monitoring of biodiversity"))
...
Gdata <- subset_förderzeitraum(years = c(2019), dataset = monitoring) ### minus Leistungsplansystematik Monitoring
