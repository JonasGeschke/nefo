...
palette_ws1[which(palette_ws1 %in% c(1:100))] <- 1
...
## Workshops alle
E(ws2)$color <- "grey"
V(ws2)$color[V(ws2)$type == "workshop"] <- "grey" # Workshops
V(ws2)$color[V(ws2)$type == "institution"] <- farben_ws1#[V(ws2)$type == "institution"] # Institutionen
V(ws2)$label.cex[V(ws2)$type == "institution"] <- 1.5 * V(ws1)$betweenness / max(V(ws1)$betweenness)+ 0.5 # Institutionen
V(ws2)$name[V(ws2)$type == "workshop"] <- NA # Netzwerke
...
# Workshops alle: Kategorien ###EDIT###
