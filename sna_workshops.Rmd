...
## Farben und Größe
E(ws2)$color_st <- "grey"
E(ws2)$color_k[E(ws2)$no_participants > 6] <-  "black" #rgb(0,0,0,max=255,alpha=1)
E(ws2)$color_k[E(ws2)$no_participants %in% c(2:5)] <- "dark grey" #rgb(169,169,169,max=255,alpha=0.8)
E(ws2)$color_k[E(ws2)$no_participants == 1] <- rgb(211,211,211,max=255,alpha=0.5) #"light grey" #
...
V(ws2)$color_k[V(ws2)$kategorie == "Bildung"] <- rgb(162,205,90,max=255)
V(ws2)$color_k[V(ws2)$kategorie == "Kirche"] <- rgb(127,127,127,max=255)
...
par(mfrow=c(1,1))
plot(ws2, vertex.size = V(ws2)$vertex.size, vertex.color = V(ws2)$color_k,
     vertex.label = NA, vertex.frame.color = V(ws2)$framecolorcover, 
     edge.arrow.size = 0, edge.color = E(ws2)$color_k,
     layout = lyout_ws)
legend(-1.6,1, title = "Kategorie", legend = c("Wissenschaft", "Behörde", "Wirtschaft", 
