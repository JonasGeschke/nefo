...
rm(rows1, rows2)
xlsx::write.xlsx(workshops_sna, file = "SNA_Statistik_Workshops_2010-2018.xls") ### EDIT
...
text(cex=1, x=max(xy)+3, y=mean(zeitlich_ws$Wissenschaft_rel, na.rm = TRUE), "Ø Wissenschaft", xpd=TRUE, pos = 4)
...
text(cex=0.8, x=xy[42], y=5, "Keine Daten", xpd=TRUE, srt=90)
legend("bottomright", inset=c(-0.4,0),
       legend = c("Keine Angabe", "Kirche", "Bildung", "Medien", "Verbände", "Wirtschaft", "Behörde", "Wissenschaft"),
...
## Farben und Größe
E(ws2)$color_st <- "grey"
E(ws2)$color_k[E(ws2)$no_participants > 6] <- "black"
E(ws2)$color_k[E(ws2)$no_participants %in% c(2:5)] <- "dark grey"
E(ws2)$color_k[E(ws2)$no_participants == 1] <- "light grey"
