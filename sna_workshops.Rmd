...
clp10000 <- clp_model(ws2, times = 10000, value = "mostoften")
clp <- clp10000
...
plot(clp, ws2, vertex.size = V(ws2)$vertex.size, col = V(ws2)$comm_col, vertex.shape = V(ws2)$vertex.shape,
     ...
     edge.arrow.size = 0, edge.color = E(ws2)$color_k,
     layout = lyout_ws, add = TRUE)
legend(-1.6,-0.2, title = "Cluster categories", legend = c("Biodiversity research Germany", 
       ...
       bty = "n")
legend(-1.6,1.2, title = "Line types", legend = c(">5 participants", "2-5 participants", "1 participant"), 
...
plot.igraph(ws2, vertex.size = V(ws2)$vertex.size, vertex.color = V(ws2)$color_k, vertex.shape = V(ws2)$vertex.shape,
     ...
     edge.arrow.size = 0, edge.color = E(ws2)$color_k,
     layout = lyout_ws, add = TRUE)
legend(-1.6,-0.2, title = "Node types", legend = c("Institution: Science", "Institution: Public authority", "Institution: Industry", 
