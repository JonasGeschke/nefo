...
rm(rows1, rows2)
xlsx::write.xlsx(workshops_sna, file = "SNA_Statistik_Workshops_biodiv.xls") ### EDIT
...
plot(workshops_sna$betweenness1 ~ workshops_sna$degree1,
     xlab = "Degree-Zentralität",
     ylab = "Betweenness-Zentralität",
     pch = 4)
#abline(lm(workshops_sna$betweenness1 ~ workshops_sna$degree1), col = "green")
```
...
plot(ws2, vertex.size = 3, vertex.color = V(ws2)$color_k,
     vertex.label = NA, vertex.frame.color = framecolorcover, 
...
plot(ws2, vertex.size = V(ws2)$vertex.size, vertex.color = V(ws2)$color_st,
     vertex.label = V(ws2)$namecover, vertex.label.family = "Calibri",
