...
clp <- clp_model(ws2, times = 1000, value = "median")
...
colrs <- c("green", "blue", "#7947d5", "#739fcd", "#4d378f", "#867dd6", "#494f7d", "khaki", "peru")
...
#pdf("Rplot_international_test.pdf", paper = "a4r")
par(mfrow=c(1,1))
E(ws2)$color_k[E(ws2)$no_participants > 6] <-  NA
E(ws2)$color_k[E(ws2)$no_participants %in% c(2:5)] <- NA
E(ws2)$color_k[E(ws2)$no_participants == 1] <- add.alpha("light grey", alpha = 0.3)
...
plot.igraph(ws2, vertex.size = V(ws2)$vertex.size, vertex.color = V(ws2)$color_k,
     ...
     edge.arrow.size = 0, edge.color = E(ws2)$color_k,
     layout = lyout_ws, add = TRUE)
legend(-1.6,-0.2, title = "Kategorie", legend = c("Wissenschaft", "Behörde", "Wirtschaft", 
                                                  "Verbände", "Medien", "Bildung", 
                                                  "Kirche", "keine Angabe"), 
