...
E(ws2)$color_k[E(ws2)$no_participants == 1] <- add.alpha("light grey", alpha = 0.3)
plot(clp, ws2, vertex.size = V(ws2)$vertex.size, col = NA,
...
E(ws2)$color_k[E(ws2)$no_participants %in% c(2:5)] <- NA
E(ws2)$color_k[E(ws2)$no_participants == 1] <- NA
plot(clp, ws2, vertex.size = V(ws2)$vertex.size, col = V(ws2)$comm_col,
...
E(ws2)$color_k[E(ws2)$no_participants %in% c(2:5)] <- NA
E(ws2)$color_k[E(ws2)$no_participants == 1] <- add.alpha("light grey", alpha = 0.3)
plot.igraph(ws2, vertex.size = V(ws2)$vertex.size, vertex.color = V(ws2)$color_k,
...
plot.igraph(ws2, vertex.size = V(ws2)$vertex.size, vertex.color = V(ws2)$color_k,
     ...
     edge.arrow.size = 0, edge.color = E(ws2)$color_k,
     layout = lyout_ws, add = TRUE)
legend(-1.6,-0.2, title = "Institution categories", legend = c("Science", "Public authority", "Industry", 
                                                  "NGO", "Media", "Education", 
                                                  "Church", "Others"), 
       fill = c(rgb(92,139,255,max=255),
                rgb(219,174,0,max=255), 
                rgb(11,33,94,max=255), 
                rgb(0,155,68,max=255), 
                rgb(180,33,0,max=255),
