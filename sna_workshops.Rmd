...
## Load raw data
Raw_workshops <- read.xlsx(file = "Daten/workshopdaten_20190219.xlsx", sheetIndex = 1, encoding="UTF-8")
Raw_workshops_info <- read.xlsx(file = "Daten/workshopdaten_20190219.xlsx", sheetIndex = 2, encoding="UTF-8")
...
WS_info <- WS_info[,-c(6,9:ncol(WS_info))]
WS_info$ID <- as.character(WS_info$ID)
WS_info$Biodiv <- as.character(WS_info$Biodiv)
WS_info$IPBES <- as.character(WS_info$IPBES)
...
Gdata_WS <- Gdata_WS[-which(is.na(Gdata_WS$Institutionskürzel..aktuell....von.uns.vergeben)),-c(57:ncol(Gdata_WS))] # Zeilen und Spalten loeschen
...
# ipbesforen, nefo, nefobiodiv, nefoipbes, 2010, 2011, 2012, 2103, 2014, 2015, 2016, 2017, 2018, 2010-2011, 2010-2012, 2010-2013, 2010-2014, 2010-2015, 2010-2016, 2010-2017, 2010-2018, 2010-2019
```
...
WS_info[c(1:23,25:27,29:30,32:38,40:45,47),8] <- V(ws2)$community_model[1:42]
```
...
legend(-1.8,-0.2, title = "Cluster descriptition", legend = c("Biodiversity research Germany", 
                                                           ...
                                                           "WS34: PESC-4",
                                                           "WS41: PESC-5",
                                                           "WS40: Evening event on the concept of nature",
                                                           "WS44: Evening event on the human-nature relationship"), 
