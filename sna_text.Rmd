...
tidy_corpus <- rBind(tidy_DNS, tidy_NBS, tidy_NSO)
```
...
documents_tfidf_ <- cBind(documents_tfidf, tfidf_)
documents_tfidf_ <- documents_tfidf_ %>%
  arrange(desc(tf_idf_))
documents_tfidf_

xlsx::write.xlsx(documents_tfidf_, file = "SDGs_term-frequency-stats.xls")
